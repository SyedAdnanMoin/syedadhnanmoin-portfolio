...
export const MY_EXPERIENCE = [
    {
        ...
        logo: '/logo/copart.png',
        highlights: [
            'Developed and validated 10+ backend features for payment and dispatch workflows using Java, Spring Boot, Kafka, REST APIs, and Solr.',
            'Investigated and resolved 40+ backend issues by analyzing application logs, Kafka events, and API responses across distributed services.',
            'Built and verified end-to-end integrations for payment reconciliation, seller billing, refunds, and exception management.',
            'Developing an AI-powered vendor recommendation system based on real-time availability, licensing, and business constraints.',
        ],
        tools: [
            { name: 'Java', icon: '/logo/java.svg' },
            { name: 'Spring Boot', icon: '/logo/springboot.svg' },
            { name: 'Kafka', icon: '/logo/kafka.png' },
            { name: 'React', icon: '/logo/react.png' },
            { name: 'Solr', icon: '/logo/solr.png' },
    ...
    },
    {
        ...
        logo: '/logo/MilliporeSigma.png',
        highlights: [
            'Architected and built an end-to-end MVP for a laboratory automation platform supporting 5+ assay workflows.',
            'Owned the full stack from database schema to responsive React dashboards and scalable REST APIs handling thousands of records per run.',
            'Implemented Redis caching that reduced API latency by 35% and GCP Cloud SQL ingestion pipelines that reduced manual processing by 40%.',
            'Extended the platform with AWS Lambda, S3, Docker, and Git-based CI/CD to improve scalability and production readiness.',
        ],
        tools: [
            { name: 'React', icon: '/logo/react.png' },
            { name: 'TypeScript', icon: '/logo/ts.png' },
    ...
    },
    {
        ...
        logo: '/logo/MorganStanley.png',
        highlights: [
            'Built full-stack features using React and Spring Boot microservices, processing more than 1 million records through REST APIs.',
            'Reduced data-processing latency by approximately 30% through optimized backend services and scheduled data workflows.',
            'Deployed containerized services using Docker and Kubernetes and automated releases through Jenkins CI/CD.',
            'Integrated Kafka and IBM MQ for event-driven services and created JUnit test suites with strong SonarQube coverage.',
        ],
        tools: [
            { name: 'React', icon: '/logo/react.png' },
            { name: 'Java', icon: '/logo/java.svg' },
    ...
    },
    {
        ...
        logo: '/logo/globcom.png',
        highlights: [
            'Developed a Java and MySQL web application for the online retail of pharmaceutical equipment.',
            'Contributed to frontend and backend modules for enterprise projects supporting Petroleum Development Oman and the Royal Oman Police.',
            'Optimized backend workflows, reducing response times by approximately 20%.',
            'Worked within Agile development cycles and gained hands-on experience across the software development lifecycle.',
        ],
        tools: [
            { name: 'Java', icon: '/logo/java.svg' },
            { name: 'MySQL', icon: '/logo/mysql.svg' },
